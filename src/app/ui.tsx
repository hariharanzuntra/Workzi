...
export function SelectField({ label, options, value, onChange, required }: {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <select value={value} onChange={e=>onChange?.(e.target.value)} className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-900 appearance-none focus:outline-none focus:ring-2 focus:ring-[#5C5CFF]">
