...
import {
  ...
  FileText, X, Bookmark, History, LayoutDashboard, Database, Info, Key, FileBarChart, Play
} from "lucide-react";
...
export function AppHeader({
  ...
  return (
    <div className="w-full bg-[#FFFFFF] border-b border-[#E8E9ED] flex flex-col flex-shrink-0 relative z-25 sticky top-0">
      ...
      {tabs.length > 0 && (
        <div className="h-[52px] flex items-center px-8 border-b border-[#EEEFF2] overflow-x-auto whitespace-nowrap">
